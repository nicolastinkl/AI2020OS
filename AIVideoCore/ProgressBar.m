...
#define BAR_BLUE_COLOR color(0, 206, 192, 1)
...
- (void)initalize
{
    ...
    //indicator
    self.progressIndicator = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, INDICATOR_W-10, INDICATOR_H)];
...
//    _progressIndicator.image = [UIImage imageNamed:@"record_progressbar_front.png"];
    ...
    _progressIndicator.transform = CGAffineTransformScale(CGAffineTransformIdentity, 0.8f, 0.8f);
