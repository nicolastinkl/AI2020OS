...
- (void)layoutSubviews {
    ...
    // available only on ios7.0 sdk. /Users/tinkl/Documents/project-xcode/iosProjce/AI2020OS/AIVideoCore/MBProgressHUD.m:526:47: 'sizeWithFont:constrainedToSize:lineBreakMode:' is deprecated: first deprecated in iOS 7.0 - Use -boundingRectWithSize:options:attributes:context:
    
    
    CGSize labelSize = [label.text sizeWithAttributes:attributes];//[label.text sizeWithFont:label.font];
    ...
    CGRect rectTest = [detailsLabel.text boundingRectWithSize:maxSize
                                              options:NSStringDrawingUsesLineFragmentOrigin
                                           attributes:attributes
                                              context:nil];
    
    CGSize detailsLabelSize = rectTest.size;// [detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
