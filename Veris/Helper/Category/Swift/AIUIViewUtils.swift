...
extension UIView {
    ...
    */
    func setCornerOnTop() {
        let maskPath = UIBezierPath(roundedRect: self.bounds, byRoundingCorners: [.TopLeft, .TopRight], cornerRadii: CGSize(width: 8.0, height: 8.0))
    ...
    */
    func setCornerOnBottom() {
        let maskPath = UIBezierPath(roundedRect: self.bounds, byRoundingCorners: [UIRectCorner.BottomLeft, UIRectCorner.BottomRight], cornerRadii: CGSize(width: 8.0, height: 8.0))
