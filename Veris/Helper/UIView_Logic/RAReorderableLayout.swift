...
class RAReorderableLayout: UICollectionViewFlowLayout, UIGestureRecognizerDelegate {
    ...
    override func layoutAttributesForElementsInRect(rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        if attributesArray != nil {
            for attribute in attributesArray! {
                let layoutAttribute = attribute as UICollectionViewLayoutAttributes
    ...
    func continuousScroll() {
        ...
        var scrollRate: CGFloat = self.continuousScrollDirection.scrollValue(self.scrollSpeedValue, percentage: percentage)
...
private class RACellFakeView: UIView {
    ...
    init(cell: UICollectionViewCell) {
        ...
        self.cellFakeImageView?.autoresizingMask = UIViewAutoresizing.FlexibleWidth
        ...
        self.cellFakeHightedView?.autoresizingMask = UIViewAutoresizing.FlexibleWidth
