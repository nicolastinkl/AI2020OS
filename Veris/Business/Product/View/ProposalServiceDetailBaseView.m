...
- (CGFloat)addPriceView:(CGFloat)positionY {
    ...
    NSString *price = [NSString stringWithFormat:@"%@ %ld %@", self.detailModel.service_price.unit, (long)self.detailModel.service_price.price, self.detailModel.service_price.billing_mode];
