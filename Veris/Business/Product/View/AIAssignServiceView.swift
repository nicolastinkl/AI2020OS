...
class AIAssignServiceView: UIView {
    ...
    class func currentView() -> AIAssignServiceView {
        let selfview = AIAssignServiceView.initFromNib() as! AIAssignServiceView

            //NSBundle.mainBundle().loadNibNamed("AIAssignServiceView", owner: self, options: nil).first  as! AIAssignServiceView
