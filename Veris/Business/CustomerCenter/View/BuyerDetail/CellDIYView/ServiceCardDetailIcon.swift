...
class ServiceCardDetailIcon: ServiceParamlView {
	...
	func layoutView() {
		...
		if let dataSource = dataSource {
			let count = dataSource.param_list.count
			for i in 0..<count {
	...
	func buildIcon() {
		timeIconImageView = UIImageView(frame: CGRect.zero)
		priceIconImageView = UIImageView(frame: CGRect.zero)
		calendarIconImageView = UIImageView(frame: CGRect.zero)
	...
	func buildIconDesc() {
		timeLabelView = UILabel(frame: CGRect.zero)
		priceLabelView = UILabel(frame: CGRect.zero)
		calendarLabelView = UILabel(frame: CGRect.zero)
