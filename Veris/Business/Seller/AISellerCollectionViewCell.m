//
//   AISellerCollectionViewCell.m
//   AIVeris
//
//  Created by zx on 6/16/16.
...
@interface AISellerCollectionViewCell ()
{
    UIView *_boardView;
...
@implementation AISellerCollectionViewCell

- (void)setSubviewAlpha:(CGFloat)subviewAlpha {
    _subviewAlpha = subviewAlpha;
    _sellerName.alpha = _subviewAlpha;
}
