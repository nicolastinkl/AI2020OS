...
class AIMockTransformManager: AITransformManager {
    ...
    init() {
        ...
        content.favoriteFromWhereURL = "http://cd.nuomi.com/deal/ampbtort.html?s=732e543b17e0d483adad32826b31011b"
 ...
 content = AITransformContentModel()
    ...
    func queryCollectedContents(_ pageNum: Int = 1, pageSize: Int = 10, tags: [AITagModel]?, origin: String?, favoriteFlag: AIFavoriteStatu?, colorFlags: [AIColorFlag]?, completion: (([AITransformContentModel], Error?)) -> Void) {
...
class AIHttpTransformManager: AIMockTransformManager {
    ...
    override func queryCollectedContents(_ pageNum: Int = 1, pageSize: Int = 10, tags: [AITagModel]?, origin: String?, favoriteFlag: AIFavoriteStatu?, colorFlags: [AIColorFlag]?, completion: (([AITransformContentModel], Error?)) -> Void) {
