...
- (void)makeSubViews
{
    _cellHeight = kTopMargin *2;        CGFloat labelWidth = CGRectGetWidth(self.frame) -kSideMargin*2 - kContentMargin*3 - kImageSize;
    ...
    UIImage *lineImage = [self createImageWithColor:[UIColor whiteColor]];
